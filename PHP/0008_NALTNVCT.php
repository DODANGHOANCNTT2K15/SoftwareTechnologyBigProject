...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0008_NALTNVCT.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
...
<body>
    ...
    <div class="main-content">
        <div class="classify">
            <a href="">Giày</a>
            <a href="">Vintas</a>
            <a href="">Vintas Jazico - Low Top</a>
        </div>
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0008_NALTNVCT/0008_NALTNVCT_02.jpeg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0008_NALTNVCT/0008_NALTNVCT_01.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0008_NALTNVCT/0008_NALTNVCT_02.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0008_NALTNVCT/0008_NALTNVCT_03.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0008_NALTNVCT/0008_NALTNVCT_04.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0008_NALTNVCT/0008_NALTNVCT_05.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0008_NALTNVCT/0008_NALTNVCT_06.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0008_NALTNVCT/0008_NALTNVCT_07.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0008_NALTNVCT/0008_NALTNVCT_08.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0008_NALTNVCT/0008_NALTNVCT_09.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0008_NALTNVCT/0008_NALTNVCT_10.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                    </ul>
            ...
            <div class="infor">
                <h1>VINTAS JAZICO - LOW TOP - ROYAL WHITE</h1>
                <p>Mã sản phẩm: <span>NALTNVCT</span></p>
                ...
                <form action="" class="form-submit" onsubmit="<?php echo ($result->num_rows > 0) ? 'return false' : 'return true'; ?>">
                    ...
                    <input type="hidden" class="product_id" value="10">
                    <input type="hidden" class="product_price" value="720000">
