...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0010_NALTUBCV.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
...
<body>
    ...
    <div class="main-content">
        <div class="classify">
            <a href="">Giày</a>
            <a href="">Track 6</a>
            <a href="">Track 6 Jazico - Low Top</a>
        </div>
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_02.jpeg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_01.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_02.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_03.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_04.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_05.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_06.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_07.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_08.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_09.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_10.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0010_NALTUBCV/0010_NALTUBCV_11.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                    </ul>
            ...
            <div class="infor">
                <h1>TRACK 6 JAZICO - LOW TOP - ROYAL WHITE</h1>
                <p>Mã sản phẩm: <span>NALTUBCV</span></p>
                <!-- <p>Tình trạng: <span>Hết hàng</span></p> -->
                <h3>1.190.000 VND</h3>
                <div class="color">
                ...
                <form action="" class="form-submit" onsubmit="<?php echo ($result->num_rows > 0) ? 'return false' : 'return true'; ?>">
                    ...
                    <input type="hidden" class="product_id" value="12">
                    <input type="hidden" class="product_price" value="1190000">
