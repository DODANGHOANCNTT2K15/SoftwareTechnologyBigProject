...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0014_NALTUVCV.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
...
<body>
    ...
    <div class="main-content">
        <div class="classify">
            <a href="">Giày</a>
            <a href="">Vintas</a>
            <a href="">Vintas Landforms - Low Top</a>
        </div>
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0014_NALTUVCV/0014_NALTUVCV_02.jpg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0014_NALTUVCV/0014_NALTUVCV_01.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0014_NALTUVCV/0014_NALTUVCV_02.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0014_NALTUVCV/0014_NALTUVCV_03.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0014_NALTUVCV/0014_NALTUVCV_04.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0014_NALTUVCV/0014_NALTUVCV_05.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0014_NALTUVCV/0014_NALTUVCV_06.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0014_NALTUVCV/0014_NALTUVCV_07.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                    </ul>
            ...
            <div class="infor">
                <h1>VINTAS LANDFORMS - LOW TOP - MARMALADE</h1>
                <p>Mã sản phẩm: <span>NALTUVCV</span></p>
                <!-- <p>Tình trạng: <span>Hết hàng</span></p> -->
                <h3>720.000 VND</h3>
                <div class="color">
                    <a href="0014_NALTUVCV.php"><button id="btn_color_1"></button></a>
                    <a href="0015_NALTNVCV.php"><button id="btn_color_2"></button></a>
                </div>
                <form action="" class="form-submit" onsubmit="<?php echo ($result->num_rows > 0) ? 'return false' : 'return true'; ?>">
                    ...
                    <input type="hidden" class="product_id" value="16">
