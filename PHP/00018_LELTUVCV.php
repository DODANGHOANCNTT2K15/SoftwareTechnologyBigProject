...
<head>
    ...
    <link rel="stylesheet" href="../CSS/00018_LELTUVCV.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
...
<body>
    ...
    <div class="main-content">
        <div class="classify">
            <a href="">Giày</a>
            <a href="">Pattas</a>
            <a href="">Ananas X Doraemon 50 Years Pattas</a>
        </div>
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_02.jpg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_01.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_02.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_03.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_04.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_05.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_06.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_07.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_08.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_09.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_010.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_11.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_12.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/00018_LELTUVCV/00018_LELTUVCV_13.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                    </ul>
            ...
            <div class="infor">
                <h1>ANANAS X DORAEMON 50 YEARS PATTAS - WHITE/CORYDALIS 50TH</h1>
                <p>Mã sản phẩm: <span>LEHTUVCV</span></p>
                <h3>890.000 VND</h3>
                <div class="describe"><p>
                Ananas x Doraemon 50 Years Pattas thể hiện chân thật nét vẽ nguyên bản của bộ truyện từ cái nhìn đầu tiên. 
                Sử dụng chất liệu Action Leather (da) phủ khắp thân giày, pha trộn cùng các chi tiết đắt giá được sắp đặt hợp lí. 
                Ra mắt với số lượng đặc biệt giới hạn, phiên bản này phát hành với mục đích kỉ niệm, tôn vinh giá trị mà bộ truyện 
                Doraemon đã mang lại suốt 50 năm qua.
                </p></div>
                <div class="color">
                    <a href=""><button id="btn_color_1"></button></a>
                </div>
                <form action="" class="form-submit"  onsubmit="<?php echo ($result->num_rows > 0) ? 'return false' : 'return true'; ?>">
                    ...
                    <input type="hidden" class="product_id" value="20">
                    <input type="hidden" class="product_price" value="890000">
...
>>>>>>> fb988e532489eab3f397139253869719a60f113d
</html>