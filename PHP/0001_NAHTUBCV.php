...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0001_NALTMBCV.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
        ...
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0001_NAHTUBCV/0001_NAHTUBCV_02.jpg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0001_NAHTUBCV/0001_NAHTUBCV_01.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0001_NAHTUBCV/0001_NAHTUBCV_02.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0001_NAHTUBCV/0001_NAHTUBCV_03.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0001_NAHTUBCV/0001_NAHTUBCV_04.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0001_NAHTUBCV/0001_NAHTUBCV_05.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0001_NAHTUBCV/0001_NAHTUBCV_06.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0001_NAHTUBCV/0001_NAHTUBCV_07.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0001_NAHTUBCV/0001_NAHTUBCV_08.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                    </ul>
            ...
            <div class="infor">
                ...
                <p>Mã sản phẩm: <span>NAHTUBCV</span></p>
                <h3>590.000 VND</h3>
                <div class="describe"><p>
                Bumper Gum EXT (Extension) NE là bản nâng cấp được xếp vào dòng sản phẩm Basas,
                 nhưng lại gây ấn tượng với diện mạo phá đi sự an toàn thường thấy. Với cách 
                 sắp xếp logo hoán đổi đầy ý tứ và mảng miếng da lộn (Suede) xuất hiện hợp lí 
                 trên chất vải canvas NE bền bỉ dày dặn nhấn nhá thêm bằng những sắc Gum dẻo dai. 
                 Tất cả làm nên 01 bộ sản phẩm với thiết kế đầy thoải mái trong trải nghiệm, đủ thanh lịch trong dáng vẻ.
                </p></div>
                <div class="color">
                ...
                <form action="" class="form-submit">
                    ...
                    <input type="hidden" class="product_price" value="590000">
                    <div class="add-cart_heart">
                        <button type="button" class="addItemBtn">Thêm vào giỏ hàng</button>
