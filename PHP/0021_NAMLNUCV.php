...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0021_NAMLNUCV.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
...
<body>
    ...
    <div class="main-content">
        <div class="classify">
            <a href="">Giày</a>
            <a href="">Urbas</a>
            <a href="">Urbas SC - Mule</a>
        </div>
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0021_NAMLNUCV/0021_NAMLNUCV_02.jpg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0021_NAMLNUCV/0021_NAMLNUCV_01.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0021_NAMLNUCV/0021_NAMLNUCV_02.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0021_NAMLNUCV/0021_NAMLNUCV_03.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0021_NAMLNUCV/0021_NAMLNUCV_04.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0021_NAMLNUCV/0021_NAMLNUCV_05.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                    </ul>
            ...
            <div class="infor">
                <h1>URBAS SC - MULE - FAIR ORCHID</h1>
                <p>Mã sản phẩm: <span>NAMLNUCV</span></p>
                <!-- <p>Tình trạng: <span>Hết hàng</span></p> -->
                <h3>580.000 VND</h3>
                <div class="color">
                    <a href="0021_NAMLNUCV.php"><button id="btn_color_1"></button></a>
                    <a href="0022_NAMLNUCV.php"><button id="btn_color_2"></button></a>
                    <a href="0023_NAMLNUCV.php"><button id="btn_color_3"></button></a>
                </div>
                <form action="" class="form-submit" onsubmit="<?php echo ($result->num_rows > 0) ? 'return false' : 'return true'; ?>">
                    ...
                    <input type="hidden" class="product_id" value="23">
