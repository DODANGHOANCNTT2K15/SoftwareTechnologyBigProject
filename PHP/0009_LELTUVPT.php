...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0009_LELTUVPT.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
...
<body>
    ...
    <div class="main-content">
        <div class="classify">
            <a href="">Giày</a>
            <a href="">Track 6</a>
            <a href="">Track 6 I.S.E.E</a>
        </div>
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0009_LELTUVPT/0009_LELTUVPT_02.jpg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0009_LELTUVPT/0009_LELTUVPT_01.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0009_LELTUVPT/0009_LELTUVPT_02.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0009_LELTUVPT/0009_LELTUVPT_03.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0009_LELTUVPT/0009_LELTUVPT_04.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0009_LELTUVPT/0009_LELTUVPT_05.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0009_LELTUVPT/0009_LELTUVPT_06.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0009_LELTUVPT/0009_LELTUVPT_07.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0009_LELTUVPT/0009_LELTUVPT_08.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0009_LELTUVPT/0009_LELTUVPT_09.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0009_LELTUVPT/0009_LELTUVPT_10.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                    </ul>
            ...
            <div class="infor">
                <h1>TRACK 6 I.S.E.E - PURE WHITE/ICY BLUE</h1>
                <p>Mã sản phẩm: <span>LETUVPT</span></p>
                ...
                <form action="" class="form-submit" onsubmit="<?php echo ($result->num_rows > 0) ? 'return false' : 'return true'; ?>">
                    ...
                    <input type="hidden" class="product_id" value="11">
                    <input type="hidden" class="product_price" value="1490000">
