...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0012_NALTUBPT.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
        ...
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0012_NALTUBPT/0012_NALTUBPT_02.jpg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0012_NALTUBPT/0012_NALTUBPT_01.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0012_NALTUBPT/0012_NALTUBPT_02.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0012_NALTUBPT/0012_NALTUBPT_03.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0012_NALTUBPT/0012_NALTUBPT_04.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0012_NALTUBPT/0012_NALTUBPT_05.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0012_NALTUBPT/0012_NALTUBPT_06.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0012_NALTUBPT/0012_NALTUBPT_07.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                    </ul>
            ...
            <div class="infor">
                <h1>VINTAS SODA POP - LOW TOP - EMERALD</h1>
                <p>Mã sản phẩm: <span>NALTUBPT</span></p>
                ...
                <form action="" class="form-submit" onsubmit="<?php echo ($result->num_rows > 0) ? 'return false' : 'return true'; ?>">
                    ...
                    <input type="hidden" class="product_id" value="14">
