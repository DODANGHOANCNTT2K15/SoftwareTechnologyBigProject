...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0006_NALTUVCT.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
...
<body>
    ...
    <div class="main-content">
        <div class="classify">
            <a href="">Giày</a>
            <a href="">Urbas</a>
            <a href="">Urbas Corluray Mix -  Low Top</a>
        </div>
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0006_NALTUVCT/0006_NALTUVCT_02.jpeg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0006_NALTUVCT/0006_NALTUVCT_01.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0006_NALTUVCT/0006_NALTUVCT_02.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0006_NALTUVCT/0006_NALTUVCT_03.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0006_NALTUVCT/0006_NALTUVCT_04.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0006_NALTUVCT/0006_NALTUVCT_05.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0006_NALTUVCT/0006_NALTUVCT_06.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0006_NALTUVCT/0006_NALTUVCT_07.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
            ...
            <div class="infor">
                <h1>URBAS CORLURAY MIX - LOW TOP - CORLURAY MIX</h1>
                <p>Mã sản phẩm: <span>NALTUVCT</span></p>
                <h3>610.000 VND</h3>
                <div class="color">
                ...
                <form action="" class="form-submit" onsubmit="<?php echo ($result->num_rows > 0) ? 'return false' : 'return true'; ?>">
                    ...
                    <input type="hidden" class="product_id" value="7">
                    <input type="hidden" class="product_price" value="610000">
