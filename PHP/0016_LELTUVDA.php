...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0016_LELTUVDA.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
...
<body>
    ...
    <div class="main-content">
        <div class="classify">
            <a href="">Giày</a>
            <a href="">Track 6</a>
            <a href="">Track 6 Unnamed No.1 In C Minor - Low Top</a>
        </div>
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0016_LELTUVDA/0016_LELTUVDA_02.jpg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0016_LELTUVDA/0016_LELTUVDA_01.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0016_LELTUVDA/0016_LELTUVDA_02.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0016_LELTUVDA/0016_LELTUVDA_03.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0016_LELTUVDA/0016_LELTUVDA_04.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0016_LELTUVDA/0016_LELTUVDA_05.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0016_LELTUVDA/0016_LELTUVDA_06.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0016_LELTUVDA/0016_LELTUVDA_07.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0016_LELTUVDA/0016_LELTUVDA_08.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0016_LELTUVDA/0016_LELTUVDA_09.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                    </ul>
            ...
            <div class="infor">
                <h1>TRACK 6 UNNAMED NO.1 IN C MINOR - LOW TOP - BLACK</h1>
                <p>Mã sản phẩm: <span>LELTUVDA</span></p>
                <h3>1.090.000 VND</h3>
                <div class="describe"><p>
                Việc sử dụng phương pháp ứng tấu (improvise) với đề bài sử dụng 5 chất liệu da khác loại, khác màu trên cùng một thiết kế 
                là chìa khoá để tạo nên đôi giày Track 6 không tên số thứ 1 (đầu tiên). Vẻ ngoài toát lên hơi hướng đượm buồn trong màu 
                giọng Đô thứ (Cm), Track 6 Unnamed No.1 in C Minor sẽ thật sự gây bất ngờ cho những ai yêu thích việc tìm thấy sự tích cực 
                trong những giai đoạn nhiều cảm xúc lẫn lộn đan xen.
                </p></div>
                <div class="color">
                ...
                <form action="" class="form-submit"  onsubmit="<?php echo ($result->num_rows > 0) ? 'return false' : 'return true'; ?>">
                    ...
                    <input type="hidden" class="product_id" value="18">
                    <input type="hidden" class="product_price" value="1090000">
