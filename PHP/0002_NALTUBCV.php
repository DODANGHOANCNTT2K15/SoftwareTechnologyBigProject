...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0002_NALTUBCV.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
        ...
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0002_NALTUBCV/0002_NALTUBCV_02.jpeg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0002_NALTUBCV/0002_NALTUBCV_01.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0002_NALTUBCV/0002_NALTUBCV_02.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0002_NALTUBCV/0002_NALTUBCV_03.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0002_NALTUBCV/0002_NALTUBCV_04.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0002_NALTUBCV/0002_NALTUBCV_05.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0002_NALTUBCV/0002_NALTUBCV_06.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0002_NALTUBCV/0002_NALTUBCV_07.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                    </ul>
            ...
            <div class="infor">
                <h1>TRACK 6 2.BLUES - LOW TOP - NAVY BLUE</h1>
                <p>Mã sản phẩm: <span>NALTUBCV</span></p>
                <h3>1.190.000 VND</h3>
                <div class="color">
                    <a href=""><button id="btn_color_1"></button></a>
                    <a href="../PHP/0004_NALTUPPT.php"><button id="btn_color_2"></button></a>
                </div>
