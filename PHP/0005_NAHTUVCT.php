...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0005_NAHTUVCT.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
...
<body>
    ...
    <div class="main-content">
        <div class="classify">
            <a href="">Giày</a>
            <a href="">Urbas</a>
            <a href="">Urbas Corluray Mix - High Top</a>
        </div>
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0005_NAHTUVCT/0005_NAHTUVCT_02.jpeg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0005_NAHTUVCT/0005_NAHTUVCT_01.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0005_NAHTUVCT/0005_NAHTUVCT_02.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0005_NAHTUVCT/0005_NAHTUVCT_03.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0005_NAHTUVCT/0005_NAHTUVCT_04.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0005_NAHTUVCT/0005_NAHTUVCT_05.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0005_NAHTUVCT/0005_NAHTUVCT_06.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0005_NAHTUVCT/0005_NAHTUVCT_07.jpeg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
            ...
            <div class="infor">
                <h1>URBAS CORLURAY MIX - HIGH TOP - CORLURAY MIX</h1>
                <p>Mã sản phẩm: <span>NAHTUVCT</span></p>
                <h3>650.000 VND</h3>
                <div class="color">
