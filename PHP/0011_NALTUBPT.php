...
<head>
    ...
    <link rel="stylesheet" href="../CSS/0011_NALTUBPT.css" type="text/css"> <!-- CSS riêng cho sản phẩm  -->
...
<body>
    ...
    <div class="main-content">
        <div class="classify">
            <a href="">Giày</a>
            <a href="">Vintas</a>
            <a href="">Vintas Soda Pop - Low Top</a>
        </div>
        <div class="main-infor">
            <div class="image">
                <div class="main-image">
                    <img src="../Picture/Product/0011_NALTUBPT/0011_NALTUBPT_02.jpg" alt="" id="mainImage">
                </div>
                <div class="second-image">
                    <i id="left" class="fa-solid fa-angle-left"></i>
                    <ul class="carousel">
                        <li class="card">
                            <img src="../Picture/Product/0011_NALTUBPT/0011_NALTUBPT_01.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0011_NALTUBPT/0011_NALTUBPT_02.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0011_NALTUBPT/0011_NALTUBPT_03.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0011_NALTUBPT/0011_NALTUBPT_04.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0011_NALTUBPT/0011_NALTUBPT_05.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0011_NALTUBPT/0011_NALTUBPT_06.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                        <li class="card">
                            <img src="../Picture/Product/0011_NALTUBPT/0011_NALTUBPT_07.jpg" alt="img" draggable="false" onclick="changeMainImage(this)">
                        </li>
                    </ul>
            ...
            <div class="infor">
                <h1>VINTAS SODA POP - LOW TOP - AMPARO BLUE</h1>
                <p>Mã sản phẩm: <span>NALTUBPY</span></p>
                <!-- <p>Tình trạng: <span>Hết hàng</span></p> -->
                <h3>680.000 VND</h3>
                <div class="color">
                    <a href="0011_NALTUBPT.php"><button id="btn_color_1"></button></a>
                    <a href="0012_NALTUBPT.php"><button id="btn_color_2"></button></a>
                    <a href="0013_NAHTUBPT.php"><button id="btn_color_3"></button></a>
                </div>
                <form action="" class="form-submit" onsubmit="<?php echo ($result->num_rows > 0) ? 'return false' : 'return true'; ?>">
                    ...
                    <input type="hidden" class="product_id" value="13">
                    <input type="hidden" class="product_price" value="680000">
